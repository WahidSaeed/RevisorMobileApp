              ...
              <Card transparent>
                <CardItem header>
                    ...
                    <View style={{ alignItems: 'flex-end',flex: 1,flexDirection: 'column' }}>
                        <View><Thumbnail style={{width:20, resizeMode: 'contain'}} source={require('../../../res/img/IMDB_Rating_Star.png')} /></View>
                        <View><Text>10/10</Text></View>
                    </View>
                </CardItem>
                <CardItem>
...
export default class IMDBReviewList extends Component {
    constructor(props){
        super(props);
    }
