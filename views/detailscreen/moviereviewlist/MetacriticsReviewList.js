              ...
              <Card transparent>
                <CardItem>
                    ...
                    <View style={{ alignItems: 'flex-end',flex: 1,flexDirection: 'column' }}>
                        <View style={{ height: 50, width: 50, borderRadius: 5, backgroundColor: 'green', padding: 10, justifyContent: 'center', alignItems: 'center' }}>
...
export default class MetacriticsReviewList extends Component {
    constructor(props){
        super(props);
    }
